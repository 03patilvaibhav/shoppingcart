...
public class RegisterAccount extends MainController{
    ...
    private boolean createAccount() throws SQLException{
        ...
        String insertDetails = "INSERT INTO cart.user(u_username,u_password,u_firstname,u_lastname,u_email,u_phone,u_state,u_city,u_pincode) VALUES('"+userNameText.getText()+"','"+passwordText.getText()+"','"+firstNameText.getText()+"','"+lastNameText.getText()+"','"+emailText.getText()+"','"+phoneText.getText()+"','"+stateNameText.getText()+"','"+cityNameText.getText()+"',"+pincodeNumber.getText()+")";
